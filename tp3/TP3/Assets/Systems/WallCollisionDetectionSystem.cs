...
public class WallCollisionDetectionSystem : ISystem
{
    ...
    public void UpdateSystem()
    {
        ComponentsManager.Instance.ForEach<ShapeComponent>((entity, shapeComponent) =>
        {
            ...
            UpdateWallCollisionDetectionSystem(entity, shapeComponent);
        });
    }

    public void UpdateWallCollisionDetectionSystem(EntityComponent entity, ShapeComponent shapeComponent)
    {
